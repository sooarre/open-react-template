...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: 'PCT-C / REBT / DB-HE5',
    paragraph: 'Acredita  el cumplimiento de las condiciones técnicas que deben tomarse en consideración en  las  instalaciones  de  energía  solar  fotovoltaica'
  };
              ...
              <div className="split-item">
                <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                  <div className="text-xxs text-color-primary fw-600 tt-u mb-8">
                    Pliego de Condiciones Técnicas deInstalaciones Conectadas a Red-ANEXO II
                  </div>
